...
//notes***
//notes***
// the number next to this.radius = is the size of the dot
var Point = function(canvas, x, y){
	...
	this.force = new FastVector(0.0,0.0).multiply(0.05 * 0.05);
	this.radius = 1.5;
};
...
Point.prototype = {
	...
	move: function() {
		if (this.inv_mass!=0){
			var new_pos = this.current.multiply(1.99).subtract(this.previous.multiply(.99)).add(this.force);
