...
<img src="smallbackgroundsliderpics/archespillars.jpg" alt="images" >
			...
			<div class="container_12">	
				...
				<div class="grid_8 alpha">
					<div class="theproject"><h1>kkkkkkkkkkk</h1></div>
					<div class="separator"></div>
						<div class="leftcol2">
							<div class="grid_2 alpha"><img src="../myportfolio/images/abouticon.jpg"/></div> 
			...
			<div class="evenrow" style="background: url(../myportfolio/images/abouticon.jpg) no-repeat #885D3B;">
				...
				<div class="container_12">
					...
					<div class="overcapacity"><img src="../myportfolio/images/abouticon.jpg" alt="image"></div>
						<div class="page" style="background:url(../myportfolio/images/abouticon.jpg) no-repeat">
							<div class="volunteertitle">
                                                            <img src="../myportfolio/images/abouticon.jpg" alt="info" style="width: 400px;"/>
                                                            <img src="../myportfolio/images/abouticon.jpg" alt="info"/>
					...
					<div class="grid_6 alpha">
						<div class="page two" style="background:url(../myportfolio/images/abouticon.jpg) no-repeat">
							<h1>pppppppppppp</h1>
...
<script>
                        var timeOnSlide = 3,
                                ...
                                pfx = '',
                                slidy = document.getElementById("slidy2");
                        ...
                        if (animation === false) {
                            ...
                            css.type = "text/css";
                            css.innerHTML += "#slidy2 { margin: 0; text-align: left; font-size: 0; position: relative; width: " + (imgCount * 100) + "%;  }\n"; // set the width for the slidy container
                            css.innerHTML += "#slidy2 img { float: left; width: " + basePercentage + "% !important; }\n";
                            ...
                            css.innerHTML += "}\n";
                            css.innerHTML += "#slidy2 { left: 0%; " + keyframeprefix + "transform: translate3d(0,0,0); " + keyframeprefix + "animation: " + totalTime + "s slidy infinite; }\n"; // call on the completed keyframe animation sequence
                            css.appendChild(document.createTextNode(""));
                            document.head.appendChild(css); // add the new stylesheet to the head of the document
                        }
                                        </script>                            
<script>
                        var timeOnSlide = 5,
                        ...
                        if (animation === false) {
                            ...
                            var imgCount = images.length, // count the number of images in the slide, including the new cloned element
                                    ...
                                    css = document.createElement("style"); // start marking a new style sheet
                            css.type = "text/css";
                            css.innerHTML += "#slidy { margin: 0; text-align: left; font-size: 0; position: relative; width: " + (imgCount * 100) + "%;  }\n"; // set the width for the slidy container
                            css.innerHTML += "#slidy img { float: left; width: " + basePercentage + "% !important; }\n";
                            css.innerHTML += "@" + keyframeprefix + "keyframes slidy {\n";
                            for (i = 0; i < (imgCount - 1); i++) { // 
                                position += slideRatio; // make the keyframe the position of the image
                                css.innerHTML += position + "% { left: -" + (i * 100) + "%; }\n";
